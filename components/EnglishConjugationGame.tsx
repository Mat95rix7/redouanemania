...
// Define the order of pronouns as a constant outside the component
const PRONOUNS_ORDER: Pronoun[] = ['I', 'you', 'he/she/it', 'we', 'you (plural)', 'they'];
...
const EnglishConjugationGame: React.FC<EnglishConjugationGameProps> = ({
  ...
  const [userAnswers, setUserAnswers] = useState<Partial<ConjugationData>>(() => {
    ...
    PRONOUNS_ORDER.forEach((pronoun) => {
